...
tg_sendText "Repo done... Cloning Device stuff"
#git clone https://github.com/phoenix-1708/local_manifest-1.git --depth=1 -b ssos12 .repo/local_manifests
git clone --depth=1 -b 12 https://github.com/rockstar5495/android_device_xiaomi_sweet device/xiaomi/sweet
git clone --depth=1 -b 12 https://github.com/rockstar5495/android_vendor_xiaomi_sweet vendor/xiaomi/sweet
git clone --depth=1 -b 12 https://github.com/AdarshGrewal/android_kernel_xiaomi_sweet kernel/xiaomi/sweet
...
mka bacon -j$(nproc --all) || make bacon -j2
